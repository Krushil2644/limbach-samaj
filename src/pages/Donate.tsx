                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center space-y-4 mb-8">
                    <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                      In the meantime, if you'd like to donate, please use the donation methods below.
                    </p>
                  </div>

                  {/* Donation Methods Card */}
                  <div className="relative bg-muted/30 backdrop-blur-sm border border-border/50 rounded-2xl p-6 max-w-2xl mx-auto mb-8">
                        ...
                        <div className="space-y-3">
                          <div className="bg-background/50 rounded-lg p-4 border border-border/30">
                            <div className="flex items-center gap-2 mb-2">
                              <span className="text-sm font-semibold text-primary">E-transfer to:</span>
                              <code className="bg-muted px-2 py-1 rounded text-sm font-mono">{siteConfig.email}</code>
                            </div>
                            <p className="text-sm text-muted-foreground">
                              When sending your e-transfer, please be sure to include your <strong>full name and telephone number</strong> to help us properly acknowledge and record your donation.
                            </p>
                            <p className="my-3 text-sm text-muted-foreground">
                              <strong>Once again, thank you for your continued support and generosity. We pray to Mataji for</strong> abundant blessings on you and your loved once.
                            </p>
                          </div>
                        </div>
                      </div>
